...
//----------------------------------------------------------------------------------------------------
    ...
    switch(taxCategory){
      ...
      case"Water_revenue":
      await driver.findElement(By.xpath("(//select/option[normalize-space()='Water revenue'])[1]")).click();
      break;
...
//----------------------------------------------------------------------------------------------------
        ...
        case"Water_revenue": 
        //sibiling xpath type***************************************************************
        await driver.findElement(By.xpath("(//select/option[normalize-space()='Water revenue'])[2]")).click();
        break;
